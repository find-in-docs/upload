...
func (dq *DocQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (dq *DocQuery) FirstIDX(ctx context.Context) uint32 {
...
func (dq *DocQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (dq *DocQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (dq *DocQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (dq *DocQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := dq.IDs(ctx)
	if err != nil {
		panic(err)
	}
