...
import (
	...
	"github.com/samirgadkari/search/ent/migrate"

	"github.com/samirgadkari/search/ent/doc"
	"github.com/samirgadkari/search/ent/user"
...
func (c *DocClient) UpdateOneID(id uint32) *DocUpdateOne {
...
func (c *DocClient) DeleteOneID(id uint32) *DocDeleteOne {
...
func (c *DocClient) Get(ctx context.Context, id uint32) (*Doc, error) {
	return c.Query().Where(doc.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *DocClient) GetX(ctx context.Context, id uint32) *Doc {
